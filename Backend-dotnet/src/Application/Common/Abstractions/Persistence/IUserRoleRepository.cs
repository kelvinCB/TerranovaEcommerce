...
public interface IUserRoleRepository
{
    ...
    /// </summary>
    /// <param name="userRoles">The collection of user roles to assign.</param>
    /// <param name="cancellationToken">A cancellation token to cancel the operation.</param>
    Task AssignRolesToUserAsync(IReadOnlyCollection<UserRole> userRoles, CancellationToken cancellationToken);
